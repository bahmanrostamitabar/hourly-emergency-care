...
Predicting the arrivals of an ED future arrivals is also studied by @choudhury2020forecasting. ARIMA, Holt-Winters, TBATS, and neutral network methods were implemented to forecast hourly accident and emergency department arrivals. ARIMA model was selected as the best fit model. Authors claimed that ARIMA has provided high and acceptable hourly ED forecasting accuracy. @hertzum2017forecasting work was mentioned in this paper. This result is surprising given the existence of multiple seasonality in the hourly dataset.
...
```{r Pinball, fig.cap= "pinball ...", fig.align='center',out.width= "90%"}
```

```{r lead-time-rel, fig.cap= "pinball ...", fig.align='center',out.width= "90%"}
```


```{r Reliability, fig.cap= "Reliability ...", fig.align='center',out.width= "90%"}
```



```{r quantile-bias, fig.cap= "Quantile ...", fig.align='center',out.width= "90%"}
```
