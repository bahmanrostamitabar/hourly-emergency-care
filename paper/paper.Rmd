...
\end{equation}
where $M$ is the metric's value for the method being considered, $M_\mathrm{ref}$ is the metric's value for a reference method. The skill score showas by how many percent the reference approach is worse than the one under consideration.
