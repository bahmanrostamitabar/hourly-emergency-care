...
Finally, Figure \@ref(fig:time-accuracy) reports the forecast accuracy of each approach versus the computational time required to generate the forecast for a given forecasting horizon of 48 hours.
