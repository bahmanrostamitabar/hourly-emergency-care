...
```{r Skill-rel2bench, fig.cap= "Pinball skill score for the seven best performing approaches.", fig.align='center',out.width= "100%"}
```
...
```{r lead-time-rmse, fig.cap= "RMSE values over the forecast horizon.", fig.align='center',out.width= "70%"}
```
...
```{r time-accuracy, fig.cap= "Speed (Running time) vs. forecast accuracy", fig.align='center',out.width="70%"}
```
